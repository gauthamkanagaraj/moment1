from.models import userid,bio,group,followers_group,posts,privatepost,like,privatereply,comment,followers_people,darkmode,notificationcount,ntime,logout
...
def t41(request):
    ...
    if del1=='1':
        ...
        d5=privatepostd3=posts.objects.filter(postid=pid).delete()
        print("post deleted")
